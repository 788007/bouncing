...
function init(){
  ...
  // var loc1 = new vector2d(20, 200);
  // var vel1 = new vector2d(3, 0);
  // balls[0] = new Mover(20, loc1, vel1, new vector2d(0,0), 'red');
  // var loc2 = new vector2d(canvas.width-20, 235);
  // var vel2 = new vector2d(-3, 0);
  // balls[1] = new Mover(20, loc2, vel2, new vector2d(0,0), 'blue');
  ...
  for(var i = 0; i < balls.length ; i++){
    ...
    //   if(balls[j].collisionTracker[i] < 10){continue;}
      ...
      if( dist <= balls[i].radius + balls[j].radius){
        ...
        vel_b1_cm.setMag(b1.vel.magnitude() * Math.cos(angleBetween));
